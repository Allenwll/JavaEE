      ...
      <table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0"> 
        <tr> 
          ...
          <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0"> 
            ...
            <form action="../M_SeleSubServlet?action=dele" method="post" name="frm"> 
                  ...
                  <td valign="top"> <table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0"> </table> 
                    ...
                    <c:forEach items="${sub}" var="sub">
                      <tr style="padding:5px;"> 
                        <td height="20" align="center">${sub.supername }</td> 
                        <td height="20" align="center">${sub.subname }</td>
                        <td align="center"><input name="delid" type="checkbox" class="noborder" value="${sub.id }"></td> 
                      </tr> 
                   </c:forEach>
                    </table> 
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
                      <tr> 
                        ...
                        <td width="40%" align="right"><input name="checkbox" type="checkbox" class="noborder" onClick="CheckAll(frm.delid,frm.checkbox)"> 
                          ...
                          <div id="ch"> 
                            <input name="delid" type="checkbox" class="noborder" value="0"> hhhhhh
                          </div></td> 
