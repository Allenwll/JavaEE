      ...
      <table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0"> 
        <tr> 
          ...
          <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0"> 
            ...
            <form action="../M_SeleSuperServlet?action=dele" method="post" name="frm"> 
              <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0"> 
                <tr> 
                  <td valign="top"> <table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0"> </table> 
                    ...
                    <c:forEach items="${sup}" var="supe">
                      <tr style="padding:5px;"> 
                        <td height="20" align="center">${supe.typeName }</td> 
                        
                        <td align="center"><input name="delid" type="checkbox" class="noborder" value="${supe.id }"></td> 
                      </tr> 
                     </c:forEach>
                    </table> 
